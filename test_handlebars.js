...
const originalTemplate = 'import type { T__hbo__schema.schemaName__hbc__ } from \'@/config/schemas/__hbo__schema.sourceName__hbc__/__hbo__schema.schemaName__hbc__\';';
...
const finalResult = decodedTemplate.replace(/\{\{schema\.schemaName\}\}/g, mockData.schema.schemaName).replace(/\{\{schema\.sourceName\}\}/g, mockData.schema.sourceName);
