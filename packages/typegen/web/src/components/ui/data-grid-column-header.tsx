        ...
        <DropdownMenu>
          ...
          <DropdownMenuContent align="start" className="w-40">
            ...
            {props.tableLayout?.columnsVisibility &&
              visibility &&
              (column.getCanSort() || column.getCanPin() || filter || customActions) && <DropdownMenuSeparator />}

            {customActions && customActions}

            {props.tableLayout?.columnsVisibility && visibility && customActions && <DropdownMenuSeparator />}
