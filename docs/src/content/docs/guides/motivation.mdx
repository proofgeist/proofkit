...
The ProofKit CLI aims to make web development easier for beginners and more effience for experienced devs. It's opinionated structure allows for more than just a starter template or bootstrapping tool, but code-mod scripts that can modify a project after the initial setup.
